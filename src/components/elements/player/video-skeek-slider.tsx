...
const VideoSeekSlider = React.forwardRef<
...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1  cursor-pointer w-full grow overflow-hidden rounded-full bg-white">
...
VideoSeekSlider.displayName = SliderPrimitive.Root.displayName

export { VideoSeekSlider }
