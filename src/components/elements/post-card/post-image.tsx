  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div
          className="w-full bg-gray-100 relative cursor-pointer hover:opacity-90 transition-all duration-300 ease-in-out transform hover:scale-[1.02]"
          style={{
            aspectRatio: image_height ? image_height / image_width : 1,
          }}
        >
          <Image
