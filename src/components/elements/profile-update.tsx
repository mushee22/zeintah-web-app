import {
  USER_PROFILE_IMAGE_UPADATE,
  USER_PROFILE_IMAGE_UPADATE_METHOD,
} from "@/constants/urls";
...
export default function ProfileUpdate({
  ...
  return (
    ...
    >
      ...
      {isPending ? (
        <div className="absolute top-0 left-0 w-full h-full bg-[#00000040] flex items-center justify-center" />
      ) : (
        <></>
      )}
      <input
        type="file"
        onChange={handleOnUpdateImage}
        accept="image/*"
